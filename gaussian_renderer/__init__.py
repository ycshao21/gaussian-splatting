...
def render(viewpoint_camera, pc : GaussianModelLimitSplits, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    """
    Render the scene. 
